...
const JOBSHEET_DATA = {
  ...
  hairi: [
    ...
    { number: 2,  title: "Audio Equipment (HTML5 Lab, Set 8)", description: "Built an HTML5 table-based page comparing Sony and JBL audio equipment, covering embedded video, links, and specification/information columns. Validated 14/14 (100%).", status: "completed", file: "jobsheets/hairi-02-audio-equipment.pdf", link: "jobsheets/hairi-02-audio-equipment.html" },
